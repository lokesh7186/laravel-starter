    ...
    <x-slot:page-heading>
        ...
        <x-slot:breadcrumb>
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">{{ __('admin.update_user') }}</a></li>
            </ol>
        </x-slot:breadcrumb>
    </x-slot:page-heading>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                ...
                <form method="POST" action="{{ route('admin.users.update', ['user' => $user->id]) }}" id="userForm" class="showLoadingOnSubmit">
                    @method('PUT')
                    @csrf
